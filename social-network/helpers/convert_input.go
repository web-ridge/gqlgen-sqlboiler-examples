...
func CommentCreateInputToModelM(
	...
	for key := range input {
		...
		case "userId":
			modelM[models.CommentColumns.UserID] = boilergql.IDToBoiler(m.UserID)
		}
	}
	return modelM
}
...
func CommentLikeCreateInputToModelM(
	...
	for key := range input {
		...
		case "userId":
			modelM[models.CommentLikeColumns.UserID] = boilergql.IDToBoiler(m.UserID)
		case "likeType":
...
func CommentLikeUpdateInputToModelM(
	...
	for key := range input {
		...
		case "userId":
			modelM[models.CommentLikeColumns.UserID] = boilergql.IDToBoiler(boilergql.PointerStringToString(m.UserID))
		case "likeType":
...
func CommentUpdateInputToModelM(
	...
	for key := range input {
		...
		case "userId":
			modelM[models.CommentColumns.UserID] = boilergql.IDToBoiler(boilergql.PointerStringToString(m.UserID))
		}
	}
	return modelM
}
...
func LikeCreateInputToModelM(
	...
	for key := range input {
		...
		case "userId":
			modelM[models.LikeColumns.UserID] = boilergql.IDToBoiler(m.UserID)
		case "likeType":
...
func LikeUpdateInputToModelM(
	...
	for key := range input {
		...
		case "userId":
			modelM[models.LikeColumns.UserID] = boilergql.IDToBoiler(boilergql.PointerStringToString(m.UserID))
		case "likeType":
...
func PostCreateInputToModelM(
	...
	for key := range input {
		...
		case "userId":
			modelM[models.PostColumns.UserID] = boilergql.IDToBoiler(m.UserID)
		}
	}
	return modelM
}
...
func PostUpdateInputToModelM(
	...
	for key := range input {
		...
		case "userId":
			modelM[models.PostColumns.UserID] = boilergql.IDToBoiler(boilergql.PointerStringToString(m.UserID))
		}
	}
	return modelM
}
