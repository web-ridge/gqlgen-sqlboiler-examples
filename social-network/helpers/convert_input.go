...
func CommentCreateInputToBoiler(
	...
	r := &models.Comment{
		...
		UserID:		boilergql.IDToBoiler(m.UserID),
	}
	return r
}
...
func CommentCreateInputToModelM(
	...
	for key := range input {
		...
		case "userId":
			modelM[models.CommentColumns.UserID] = model.UserID
		}
	}
	return modelM
}
...
func CommentLikeCreateInputToModelM(
	...
	for key := range input {
		...
		case "userId":
			modelM[models.CommentLikeColumns.UserID] = model.UserID
		case "likeType":
...
func CommentLikeUpdateInputToBoiler(
	...
	r := &models.CommentLike{
		...
		UserID:		boilergql.IDToBoiler(boilergql.PointerStringToString(m.UserID)),
...
func LikeCreateInputToModelM(
	...
	for key := range input {
		...
		case "userId":
			modelM[models.LikeColumns.UserID] = model.UserID
		case "likeType":
...
func PostCreateInputToModelM(
	...
	for key := range input {
		...
		case "userId":
			modelM[models.PostColumns.UserID] = model.UserID
		}
	}
	return modelM
}
