...
func (ec *executionContext) field_Query_users_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["ordering"]; ok {
		...
		arg2, err = ec.unmarshalOUserOrdering2ᚕᚖgithubᚗcomᚋwebᚑridgeᚋgqlgenᚑsqlboilerᚑexamplesᚋissueᚑ6ᚑedgesᚑconnectionsᚋgraphql_modelsᚐUserOrderingᚄ(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
	...
	if tmp, ok := rawArgs["filter"]; ok {
		...
		arg3, err = ec.unmarshalOUserFilter2ᚖgithubᚗcomᚋwebᚑridgeᚋgqlgenᚑsqlboilerᚑexamplesᚋissueᚑ6ᚑedgesᚑconnectionsᚋgraphql_modelsᚐUserFilter(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
