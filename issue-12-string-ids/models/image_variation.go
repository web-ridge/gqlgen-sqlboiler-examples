...
var ImageVariationWhere = struct {
	...
	ID:      whereHelperstring{field: "`image_variation`.`id`"},
	ImageID: whereHelperstring{field: "`image_variation`.`image_id`"},
}
...
var (
	...
	imageVariationColumnsWithoutDefault = []string{"id", "image_id"}
	imageVariationColumnsWithDefault    = []string{}
