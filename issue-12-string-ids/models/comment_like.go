...
var CommentLikeWhere = struct {
	...
	ID:        whereHelperstring{field: "`comment_like`.`id`"},
	CommentID: whereHelperstring{field: "`comment_like`.`comment_id`"},
	UserID:    whereHelperstring{field: "`comment_like`.`user_id`"},
...
var (
	...
	commentLikeColumnsWithoutDefault = []string{"id", "comment_id", "user_id", "created_at", "like_type"}
	commentLikeColumnsWithDefault    = []string{}
