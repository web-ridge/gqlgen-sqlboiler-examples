...
func testPostToManySetOpComments(t *testing.T) {
	var err error
...
func testPostToManyRemoveOpComments(t *testing.T) {
	var err error
...
var (
	postDBTypes = map[string]string{`ID`: `varchar`, `Content`: `text`, `UserID`: `varchar`}
	_           = bytes.MinRead
)
