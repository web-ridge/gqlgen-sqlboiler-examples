...
func testCommentToOneRemoveOpPostUsingPost(t *testing.T) {
	var err error
...
var (
	commentDBTypes = map[string]string{`ID`: `varchar`, `Content`: `text`, `PostID`: `varchar`, `UserID`: `varchar`}
	_              = bytes.MinRead
)
