...
var (
	...
	postColumnsWithoutDefault = []string{"id", "content", "user_id"}
...
func (postL) LoadImages(ctx context.Context, e boil.ContextExecutor, singular bool, maybePost interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`image`),
		qm.WhereIn(`image.post_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (postL) LoadLikes(ctx context.Context, e boil.ContextExecutor, singular bool, maybePost interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`like`),
		qm.WhereIn(`like.post_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Post) SetComments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Comment) error {
	query := "update `comment` set `post_id` = null where `post_id` = ?"
