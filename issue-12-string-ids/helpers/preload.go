...
var PostPreloadMap = map[string]boilergql.ColumnSetting{
	...
	"user.commentLikes.comment": boilergql.ColumnSetting{
		Name:        models.PostRels.User + "." + models.UserRels.CommentLikes + "." + models.CommentLikeRels.Comment,
		IDAvailable: false,
	},
	"user.commentLikes.user": boilergql.ColumnSetting{
	...
	"user.likes.post": boilergql.ColumnSetting{
		Name:        models.PostRels.User + "." + models.UserRels.Likes + "." + models.LikeRels.Post,
		IDAvailable: false,
	},
	"user.likes.user": boilergql.ColumnSetting{
